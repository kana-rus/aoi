...
// use aoi_components::{request::{range::{RangeList, RangeMap, HeaderRangeMap}, buffer::Buffer}, response::Response};
// use crate::result::HandleResult;
// 
// pub(crate) type HandleFunc = Box<dyn
//     Fn(Buffer, RangeList, RangeMap, HeaderRangeMap, Option<String>)
//         -> Pin<Box<dyn Future<Output=HandleResult> + Send >>
//     + Send + Sync
// >;
// 
// pub trait Handler<P> {
//     fn into_handlefunc(self) -> (HandleFunc, u8/*path param count*/);
    ...
    /*
        Internally, aoi's "handler"s are：
